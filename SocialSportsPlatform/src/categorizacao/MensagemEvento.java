...
public class MensagemEvento {
	...
	public static void recebeMensagem(String hashtag_evento, int modalidade, String utilizador, String imagem, String mensagem, 
			String data_criacao, String lingua, String fonte, Vector<String> vec_mensagens) throws IOException, ParseException{
		if(!tipoResposta(mensagem) && minimoChars(hashtag_evento, mensagem)){
			if(!mensagemDuplicada(hashtag_evento,mensagem, data_criacao, vec_mensagens) && !conteudosImproprios(mensagem, lingua)){
				String tipo_mensagem = identificaTipoMensagem(mensagem, modalidade, lingua);
				GereIndiceEventos.InsereMensagemEvento(hashtag_evento, utilizador, imagem, mensagem, data_criacao, lingua, tipo_mensagem, fonte);
			}
		}
	}
...
//			System.out.println("Valor de jaccard: " + e);
	...
	public static void recebeMensagemAppM(String id,String hashtag_evento, int modalidade, String utilizador, String imagem, 
			String mensagem, String data_criacao, String lingua, String fonte) throws IOException {
		// TODO Auto-generated method stub
		String tipo_mensagem  = identificaTipoMensagem(mensagem, modalidade, lingua);
		GereIndiceEventos.InsereMensagemEventoAppM(id, hashtag_evento, utilizador, imagem, mensagem, data_criacao, lingua, tipo_mensagem, fonte);
	}
}
