...
public class MensagemJogador {
	...
	public static void recebeMensagem(String hashtag_jogador, int modalidade, String utilizador, String imagem, String mensagem, 
			String data_criacao, String lingua, String fonte, Vector<String> vec_mensagens) throws IOException, ParseException{
		if(!tipoResposta(mensagem) && minimoChars(hashtag_jogador, mensagem)){
			if(!mensagemDuplicada(hashtag_jogador,mensagem, data_criacao, vec_mensagens) && !conteudosImproprios(mensagem, lingua)){
				String tipo_mensagem = identificaTipoMensagem(mensagem, modalidade, lingua);
				GereIndiceJogadores.InsereMensagemJogadores(hashtag_jogador, utilizador, imagem, mensagem, data_criacao, lingua, tipo_mensagem, fonte);
			}
		}
	}
	...
	private static boolean mensagemDuplicada(String hashtag, String mensagem, String data_criacao,
			Vector<String> vec_mensagens) throws IOException, ParseException {
		// TODO Auto-generated method stub
...
//			System.out.println("Valor de jaccard: " + e);
	...
	//método que devolve true se encontrar asneiras na mensagem (en)
	...
	//método que devolve true se encontrar asneiras na mensagem (pt)
	...
	public static void recebeMensagemAppM(String id, String hashtag_jogador, int modalidade, String utilizador, String imagem, 
			String mensagem, String data_criacao, String lingua, String fonte) throws IOException {
		// TODO Auto-generated method stub
		String tipo_mensagem  = identificaTipoMensagem(mensagem, modalidade, lingua);
		GereIndiceJogadores.InsereMensagemJogadoresAppM(id, hashtag_jogador, utilizador, imagem, mensagem, data_criacao, lingua, tipo_mensagem, fonte);
	}
