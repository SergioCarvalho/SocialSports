...
public class GereIndiceEventos {
	
	public static void InsereMensagemEvento(String hashtag_evento, String utilizador, String imagem, String mensagem,
		...
		adicionaMensagemEventoIndice(hashtag_evento, utilizador, imagem, mensagem, data_ano_mes_dia, data_hora_minuto,
				data_amd_formatada, data_hm_formatada, lingua, tipo_mensagem, fonte);

	}

	private static void adicionaMensagemEventoIndice(String hashtag_evento,
		...
		//ISTO ESTÁ AQUI PARA FAZER O TESTE DE GERAR FICHEIROS COM A MENSAGEM E O TIPO
		//PARA ESCREVER OS FICHEIROS DEPOIS TENHO DE TIRAR ISTO DAQUI!!!!!
		File file = new File("C:\\Workspace\\SocialSports\\Ficheiros\\Hashtags\\" + hashtag_evento + ".txt");
		FileWriter fwriter;
		if(!file.exists())
		...
		File file = new File("C:\\Workspace\\SocialSports\\Indices_Lucene\\" + hashtag_evento);
...
//		como resultado de pesquisas
		...
		doc.add(new Field("hashtag", hashtag_evento, Field.Store.YES, Index.ANALYZED));
	...
	public static void InsereMensagemEventoAppM(String id, String hashtag_evento,
			String utilizador, String imagem, String mensagem,
			String data_criacao, String lingua, String tipo_mensagem,
			String fonte) throws IOException {
		// TODO Auto-generated method stub
		String data_ano_mes_dia = FerramentasData.devolveDataAnoMesDia(data_criacao);
		String data_hora_minuto = FerramentasData.devolveDataHoraMinuto(data_criacao);
		String data_amd_formatada = FerramentasData.devolveDataAnoMesDiaF(data_criacao);
		...
		adicionaMensagemEventoAppMIndice(id, hashtag_evento, utilizador, imagem, mensagem, data_ano_mes_dia, data_hora_minuto,
				data_amd_formatada, data_hm_formatada, lingua, tipo_mensagem, fonte);
	}

	private static void adicionaMensagemEventoAppMIndice(String id, String hashtag_evento,
			String utilizador, String imagem, String mensagem,
			String data_ano_mes_dia, String data_hora_minuto,
			String data_amd_formatada, String data_hm_formatada, String lingua,
			String tipo_mensagem, String fonte) throws IOException {
		// TODO Auto-generated method stub
		StandardAnalyzer analyzer = new StandardAnalyzer(Version.LUCENE_34);
		File file = new File("C:\\Workspace\\SocialSports\\Indices_LuceneAppM\\" + hashtag_evento);
		Directory index = new SimpleFSDirectory(file);
		IndexWriterConfig iwc = new IndexWriterConfig(Version.LUCENE_34, analyzer);
		if(!file.exists()){
			iwc.setOpenMode(OpenMode.CREATE);
