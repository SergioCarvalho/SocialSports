...
public class GereIndiceJogadores {

	public static void InsereMensagemJogadores(String hashtag_jogador, String utilizador, String imagem, String mensagem,
		...
		adicionaMensagemJogadorIndice(hashtag_jogador, utilizador, imagem, mensagem, data_ano_mes_dia, data_hora_minuto,
				data_amd_formatada, data_hm_formatada, lingua, tipo_mensagem, fonte);

	}

	private static void adicionaMensagemJogadorIndice(String hashtag_jogador,
		...
		File file = new File("C:\\Workspace\\SocialSports\\Ficheiros\\Hashtags\\" + hashtag_jogador + ".txt");
		FileWriter fwriter;
		if(!file.exists())
		...
		File file = new File("C:\\Workspace\\SocialSports\\Indices_Lucene\\" + hashtag_jogador);
	...
	public static void InsereMensagemJogadoresAppM(String id, String hashtag_jogador,
			String utilizador, String imagem, String mensagem,
		...
		adicionaMensagemJogadorAppMIndice(id, hashtag_jogador, utilizador, imagem, mensagem, data_ano_mes_dia, data_hora_minuto,
				data_amd_formatada, data_hm_formatada, lingua, tipo_mensagem, fonte);
	}

	private static void adicionaMensagemJogadorAppMIndice(String id,
			String hashtag_jogador, String utilizador, String imagem,
			String mensagem, String data_ano_mes_dia, String data_hora_minuto,
			String data_amd_formatada, String data_hm_formatada, String lingua,
			String tipo_mensagem, String fonte) throws IOException{
		// TODO Auto-generated method stub
		StandardAnalyzer analyzer = new StandardAnalyzer(Version.LUCENE_34);
